...
/**
 * Sneak in an entry and make it the head
 * 
*/
LRUCache.prototype.sneakIn = function(key, value) {
  ...
  if (this.head) {
    // link current head to the new head (entry)
...
LRUCache.prototype.MRU = function() {
...
LRUCache.prototype.toString = function() {
  var s = '', entry = this.head;
  while (entry) {
    s += String(entry.key)+':'+entry.value.title;
    entry = entry.newer;
    if (entry)
      s += ' < ';
  }
